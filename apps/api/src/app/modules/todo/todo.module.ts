...
@Module({
  ...
  controllers: [CategoryController, TodoListItemController, TodoListController],
  providers: [CategoryService, TodoListItemService, TodoListService],
  exports: [CategoryService, TodoListItemService, TodoListService],
})
